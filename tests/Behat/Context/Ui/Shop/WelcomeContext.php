...
namespace Tests\Wishibam\SyliusMondialRelayPlugin\Behat\Context\Ui\Shop;

use Behat\Behat\Context\Context;
use Tests\Wishibam\SyliusMondialRelayPlugin\Behat\Page\Shop\WelcomePageInterface;
